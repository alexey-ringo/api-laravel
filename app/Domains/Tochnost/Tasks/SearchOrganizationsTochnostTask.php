...
class SearchOrganizationsTochnostTask extends AbstractCollectionDataMetaTochnostTask
{
    protected string $apiPath = '/service/organizations/search';
    protected string $responseDataDtoClassName = SearchOrganizationsTochnostResponseDataDto::class;
...
//            return new SearchOrganizationsTochnostResponseDataDto($item);
//        });
//        $responseLinksDto = new SearchOrganizationsTochnostResponseLinksDto($responseJson['links']);
//        $responseMetaDto = new SearchOrganizationsTochnostResponseMetaDto($responseJson['meta']);
//
//        $responseDto = new SearchOrganizationsTochnostResponseDto(
//            data: $responseDataDto,
//            links: $responseLinksDto->toArray(),
//            meta: $responseMetaDto->toArray()
//        );
//
//
