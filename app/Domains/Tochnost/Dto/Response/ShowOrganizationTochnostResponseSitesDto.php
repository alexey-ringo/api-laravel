...
/**
 * Class ShowOrganizationTochnostResponseSitesDto
 * @package App\Domains\Tochnost\Dto\Response
 *
 * @OA\Schema(
 *     title="ShowOrganizationTochnostResponseSitesDto",
 ...
 *
 */
class ShowOrganizationTochnostResponseSitesDto extends DataTransferObject
{
    public int $id;
