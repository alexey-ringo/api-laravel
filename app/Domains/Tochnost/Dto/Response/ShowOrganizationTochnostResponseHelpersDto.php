...
/**
 * Class ShowOrganizationTochnostResponseHelpersDto
 * @package App\Domains\Tochnost\Dto\Response
 *
 * @OA\Schema(
 *     title="ShowOrganizationTochnostResponseHelpersDto",
 ...
 *
 */
class ShowOrganizationTochnostResponseHelpersDto extends DataTransferObject
{
    public int $id;
    public string $name;
    public string $slug;
