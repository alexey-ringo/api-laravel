...
/**
 * Class CrowdfundingCollectionSluchaemResponseDataDto
 * @package App\Domains\Sluchaem\Dto
 *
 * @OA\Schema(
 *     title="CrowdfundingCollectionSluchaemResponseDataDto",
 *     description="CrowdfundingCollectionSluchaemResponseDataDto",
 *     @OA\Property(
 ...
 *     ),
 *     @OA\Property(
 *         property="theme_author",
 *         type="string",
 *         example="Имя создателя кейса",
 *     ),
 *     @OA\Property(
 *         property="link",
 *         type="string",
 ...
 *     ),
 *     @OA\Xml(
 *         name="CrowdfundingCollectionSluchaemResponseDataDto"
 *     )
 * )
 *
 */
class CrowdfundingCollectionSluchaemResponseDataDto extends DataTransferObject
{
