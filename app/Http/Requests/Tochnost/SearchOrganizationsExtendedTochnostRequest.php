...
/**
 * Class SearchOrganizationsExtendedTochnostRequest
 * @package App\Http\Requests\Tochnost
 *
 * @OA\Schema(
 *     title="Request Search Organization Extended",
 ...
 *
 */
class SearchOrganizationsExtendedTochnostRequest extends FormRequest
{
    public function rules()
    {
        return [
            ...
            'problem_path_group' => 'nullable|array',
            ...
            'income_source_slug' => 'nullable|string',
