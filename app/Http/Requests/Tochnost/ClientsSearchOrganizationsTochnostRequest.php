...
/**
 * Class ClientsSearchOrganizationsTochnostRequest
 * @package App\Http\Requests\Tochnost
 *
 * @OA\Schema(
 *     title="Clients search organizations",
 *     description="Clients search organizations",
 *     @OA\Parameter(
 *         name="search_text",
 *         in="query",
 *         required=false,
 ...
 *
 */
class ClientsSearchOrganizationsTochnostRequest extends FormRequest
{
